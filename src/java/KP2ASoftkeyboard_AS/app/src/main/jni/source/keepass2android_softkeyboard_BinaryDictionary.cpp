...
extern "C" JNIEXPORT jlong JNICALL Java_keepass2android_softkeyboard_BinaryDictionary_openNative(JNIEnv *env, jobject object, jobject dictDirectBuffer,
...
extern "C" JNIEXPORT int JNICALL Java_keepass2android_softkeyboard_BinaryDictionary_getSuggestionsNative(
...
extern "C" JNIEXPORT int JNICALL Java_keepass2android_softkeyboard_BinaryDictionary_getBigramsNative(JNIEnv *env, jobject object, jlong dict, jcharArray prevWordArray, jint prevWordLength,
...
extern "C" JNIEXPORT jboolean JNICALL Java_keepass2android_softkeyboard_isValidWordNative(JNIEnv *env, jobject object, jlong dict, jcharArray wordArray, jint wordLength)
{
    Dictionary *dictionary = (Dictionary *)dict;
    if (dictionary == NULL)
...
extern "C" JNIEXPORT void JNICALL Java_keepass2android_softkeyboard_BinaryDictionary_closeNative(JNIEnv *env, jobject object, jlong dict)
{
    Dictionary *dictionary = (Dictionary *)dict;
