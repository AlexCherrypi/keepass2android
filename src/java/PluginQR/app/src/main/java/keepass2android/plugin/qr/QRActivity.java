...
public class QRActivity extends Activity {
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			boolean includeLabel = PreferenceManager.getDefaultSharedPreferences(getActivity())
					.getBoolean("includeLabels", false);
			...
			mCbIncludeLabel.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
					PreferenceManager.getDefaultSharedPreferences(getActivity()).edit().putBoolean("includeLabels",
							isChecked);
		...
		private void updateQrCode(String qrData) {
			...
			WindowManager wm = (WindowManager) getActivity().getSystemService(Context.WINDOW_SERVICE); // the results
																										// will be
																										// higher than
																										// using the
																										// activity
