...
#define neh_enc_gen_key(x) ((x) == 128 ? (NEH_ENC_GEN | NEH_KEY128) : (x) == 192 ? (NEH_ENC_GEN | NEH_KEY192) \
                                                                                 : (NEH_ENC_GEN | NEH_KEY256))

#define neh_enc_load_key(x) ((x) == 128 ? (NEH_ENC_LOAD | NEH_KEY128) : (x) == 192 ? (NEH_ENC_LOAD | NEH_KEY192) \
                                                                                   : (NEH_ENC_LOAD | NEH_KEY256))

#define neh_enc_hybrid_key(x) ((x) == 128 ? (NEH_ENC_GEN | NEH_KEY128) : (x) == 192 ? (NEH_ENC_LOAD | NEH_KEY192) \
                                                                                    : (NEH_ENC_LOAD | NEH_KEY256))

#define neh_dec_gen_key(x) ((x) == 128 ? (NEH_DEC_GEN | NEH_KEY128) : (x) == 192 ? (NEH_DEC_GEN | NEH_KEY192) \
                                                                                 : (NEH_DEC_GEN | NEH_KEY256))

#define neh_dec_load_key(x) ((x) == 128 ? (NEH_DEC_LOAD | NEH_KEY128) : (x) == 192 ? (NEH_DEC_LOAD | NEH_KEY192) \
                                                                                   : (NEH_DEC_LOAD | NEH_KEY256))

#define neh_dec_hybrid_key(x) ((x) == 128 ? (NEH_DEC_GEN | NEH_KEY128) : (x) == 192 ? (NEH_DEC_LOAD | NEH_KEY192) \
                                                                                    : (NEH_DEC_LOAD | NEH_KEY256))
...
#define VIA_ACE_AVAILABLE (((via_flags & NEH_ACE_FLAGS) == NEH_ACE_FLAGS) || (via_flags & NEH_CPU_READ) && (via_flags & NEH_CPU_IS_VIA) || via_ace_test())
...
#define VIA_RNG_AVAILABLE (((via_flags & NEH_RNG_FLAGS) == NEH_RNG_FLAGS) || (via_flags & NEH_CPU_READ) && (via_flags & NEH_CPU_IS_VIA) || via_rng_test())
