...
public abstract class PluginActionBroadcastReceiver extends BroadcastReceiver {
	...
	protected class ActionSelectedAction extends PluginEntryActionBase {
		...
		/**
		 * 
		 * @return the Bundle associated with the action. This bundle can be set in
		 *         OpenEntry.add(Entry)FieldAction
		 */
		...
		/**
		 * 
		 * @return the field id which was selected. null if an entry action (in the
		...
		/**
		 * 
		 * @return true if an entry action, i.e. an option from the options menu, was
		 *         selected. False if an option
	...
	protected class OpenEntryAction extends PluginEntryActionBase {
		...
		public void addEntryAction(String actionDisplayText, int actionIconResourceId, Bundle actionData)
				throws PluginAccessException {
			addEntryFieldAction(null, null, actionDisplayText, actionIconResourceId, actionData);
		}

		public void addEntryFieldAction(String actionId, String fieldId, String actionDisplayText,
				int actionIconResourceId, Bundle actionData) throws PluginAccessException {
	...
	public void onReceive(Context ctx, Intent intent) {
		...
		android.util.Log.d("KP2A.pluginsdk",
